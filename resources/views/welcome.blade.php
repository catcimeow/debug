...
@section('content')
    ...
    <style>
        ...
        .welcome-message {
            ...
            z-index: 1; /* Ensure the message appears above other elements */
        }
    ...
    z-index: 1000;
    width: 100%;
    max-height: 200px; /* Optional: to limit height and make it scrollable */
    overflow-y: auto; /* Optional: for scrollable suggestions */
...
<head>
<script src="{{ asset('js/bakedgood.js') }}"></script>
</head>
    <!-- Main Content -->
    <div class="container mt-4">
        ...
        <div class="search-bar">
            <input type="text" id="itemSearch" name="q" class="form-control" placeholder="Search for baked goods...">
