...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
<!-- Include jQuery (Bootstrap 4 requires it) -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: #D7BDFE;">
            <div class="container">
                <img src="{{ asset('uploaded_files/logo.png') }}" alt="Logo" width="40" height="40"
